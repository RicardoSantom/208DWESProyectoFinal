...
<html lang="es">
    ...
    <head>
        ...
        <title>Script comprobacion T01_Usuario</title>
    </head>
    <body>
        <header>
        ...
        <main>
            <article>
                <h3>script comprobación de datos T01_Usuario</h3>
                <?php
                ...
                try {
                    ...
                    echo "<table><thead><tr><th>T01_CodUsuario</th><th>T01_Password</th><th>T01_DescUsuario</th><th>T01_NumConexiones</th>"
                    . "<th>T01_FechaHoraUltimaConexion</th><th>T01_Perfil</th><th>T01_ImagenUsuario</th></tr></thead><tbody>";
